                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                {/* <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-3 border-2 rounded-lg shadow-sm transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-primary-normal/20 focus:border-primary-normal ${errors.phone ? 'border-red-400 bg-red-50' : 'border-gray-200 hover:border-gray-300'
                                            }`}
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <PhoneInput
                                                {...field}
                                                id="phone"
                                                defaultCountry="RW" // 🇷🇼 or change to your default country
                                                international
                        ...
                        <div className="mb-10">
                            ...
                            <div className="mb-6">
                                ...
                                >
                                    ...
                                    <option value="implementation">🚀 Platform Implementation</option>
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    placeholder="Tell us about your inquiry, questions, or how we can help transform your community with Smart Village platform..."
                                />
                                {errors.message && (
