...
export const env = {
  // API Configuration
  API_BASE_URL: import.meta.env.VITE_API_BASE_URL || 'https://smartville.onrender.com',
  ...
  SITE_NAME: import.meta.env.VITE_SITE_NAME || 'Smart Village Community Platform',
  SITE_DESCRIPTION: import.meta.env.VITE_SITE_DESCRIPTION || 'Join your local community platform',
